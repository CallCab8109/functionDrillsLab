...
function add (let1, let2){
  let lets1 = Number(let1)
  let lets2 = Number(let2)
  console.log(lets1 + lets2)
}
// let sum = add ('3', 4)
...
let MOVIEPARAM = bestMovie ('sharknado')
...
function bloodMoney(gold) {
   return (gold / 3)
  
}

let totalFrogs = bloodMoney(359)
...
*/
math = [i]
function bloodMoney2(gold) {
  let gold1 = (gold / 3)
  console.log(Math.floor(gold1));
}

let totalFrogs2 = bloodMoney2(359)
